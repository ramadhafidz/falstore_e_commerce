                  ...
                  <div class="wg-box">
                    ...
                    <div class="cols gap22">
                      <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter regular price" name="regular_price" tabindex="0" value=""
                          aria-required="true" required="">
                      </fieldset>
                    ...
                    <div class="cols gap22">
                      ...
                      <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter quantity" name="quantity" tabindex="0" value=""
                          aria-required="true" required="">
                      </fieldset>
